...
def ensure_collection(
    ...
    """
    Create the VaaniRAG Qdrant collection if it does not exist.
...
def upload_vectors(
    ...
    The original VaaniRAG vector ID is preserved in payload.
    """
    ...
    for offset in range(
        ...
        for record in batch:
            ...
            # ------------------------------------------------
            # Convert deterministic VaaniRAG ID into UUID.
            #
            # Example:
            # en_abc123...
            #
